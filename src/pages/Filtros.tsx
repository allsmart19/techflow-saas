...
export default function Filtros() {
  ...
  useEffect(() => {
    const savedDataInicio = localStorage.getItem(STORAGE_KEYS.DATA_INICIO)
    const savedDataFim = localStorage.getItem(STORAGE_KEYS.DATA_FIM)
    const savedMes = localStorage.getItem(STORAGE_KEYS.MES)
    const savedFornecedor = localStorage.getItem(STORAGE_KEYS.FORNECEDOR)
    const savedCondicao = localStorage.getItem(STORAGE_KEYS.CONDICAO)
  ...
  useEffect(() => {
    if (pedidos.length > 0) {
      localStorage.setItem(STORAGE_KEYS.DATA_INICIO, dataInicio)
      localStorage.setItem(STORAGE_KEYS.DATA_FIM, dataFim)
      localStorage.setItem(STORAGE_KEYS.MES, mesSelecionado)
      localStorage.setItem(STORAGE_KEYS.FORNECEDOR, fornecedorSelecionado)
      localStorage.setItem(STORAGE_KEYS.CONDICAO, condicaoSelecionada)
  ...
  function limparFiltros() {
    ...
    localStorage.removeItem(STORAGE_KEYS.DATA_INICIO)
    localStorage.removeItem(STORAGE_KEYS.DATA_FIM)
    localStorage.removeItem(STORAGE_KEYS.MES)
    localStorage.removeItem(STORAGE_KEYS.FORNECEDOR)
    localStorage.removeItem(STORAGE_KEYS.CONDICAO)
