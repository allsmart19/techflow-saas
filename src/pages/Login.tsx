...
const handleGoogleLogin = async () => {
  ...
  if (error) {
    ...
    alert("E-mail de recuperação enviado! Verifique sua caixa de entrada e siga as instruções.")
  }
...
<div className="text-center mb-4">
  ...
  disabled={loading}
  className="w-full bg-white border border-gray-300 text-gray-700 py-2 rounded-lg font-medium hover:bg-gray-50 transition flex items-center justify-center gap-3 shadow-sm"
>
