...
export default function Ajustes() {
  ...
  function carregarDadosLocal() {
    ...
    if (savedFornecedores) {
      ...
      localStorage.setItem("fornecedores", JSON.stringify(defaultFornecedores))
    }
    ...
    if (savedMarcas) {
      ...
      localStorage.setItem("marcas", JSON.stringify(defaultMarcas))
    }
    ...
    if (savedCondicoes) {
      ...
      localStorage.setItem("condicoes", JSON.stringify(defaultCondicoes))
    }
  }
  ...
  const adicionarMarca = () => {
    if (novaMarca.trim()) {
      ...
      localStorage.setItem("marcas", JSON.stringify(novasMarcas))
      setNovaMarca("")
  ...
  const adicionarCondicao = () => {
    if (novaCondicao.trim()) {
      ...
      localStorage.setItem("condicoes", JSON.stringify(novasCondicoes))
      setNovaCondicao("")
